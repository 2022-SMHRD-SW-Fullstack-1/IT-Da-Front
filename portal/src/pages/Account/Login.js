      ...
      <div className='loginContainer'>
         <div className='topDiv'>
            <div className='loginTab'>
               <button onClick={() => { setTab(true); setId(''); setPw(''); }}>회원로그인</button>
               <button onClick={() => { setTab(false); setKey('') }}>기업로그인</button>
            </div>
            {tab ? (
               <div className='memberLogin'>
                  ...
                  <div>
                     <span>아이디 찾기</span>|
                     <span>비밀번호 찾기</span>|
                     <span onClick={onClickRegister}>회원가입</span>
                  </div>
               </div>
            ) : (
               <div className='enterpriseLogin'>
                  <input ref={inputKey} onChange={onKeyChange} value={key} type='text' placeholder='키를 입력해주세요'></input>
                  <div>
                     <input type='checkbox'></input>
                     <span>로그인 유지</span>
                     <input type='checkbox'></input>
