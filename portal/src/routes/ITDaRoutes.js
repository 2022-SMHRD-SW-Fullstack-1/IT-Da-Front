...
const ITDaRoutes = () => {
   ...
   //Navbar용 메뉴 리스트
   const menuList_t = [{ title: "수업관리", subtitle: [{ title: "공지사항", url: "/announcement" }, { title: "강의 일정", url: "/" }, { title: "공유 자료실", url: "/" }, { title: "연장사용 신청서", url: "/" }] }, { title: "프로젝트", subtitle: [{ title: "프로젝트 관리", url: "/" }] }, { title: "학생관리", subtitle: [{ title: "출결 관리", url: "/" }, { title: "학생 정보", url: "/resume" }] }]
